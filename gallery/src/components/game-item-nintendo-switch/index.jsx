...
// https://www.svgrepo.com/svg/342069/nintendo-switch
const GameNintendoSwitch = ({ screenshotsURL, languages, version }) => {
  const title = `Open screenshots taken on Nintendo Switch (game version: ${version}, languages: ${languages})`;
  return (
    <a key="switch" href={screenshotsURL} className="px-2 lg:pl-0 lg:pr-2" title={title}>
      <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 32 32" className="w-6 h-6 text-blue-600">
...
export default GameNintendoSwitch;
