...
// https://www.svgrepo.com/svg/306576/playstationvita
const GamePSVita = ({ screenshotsURL, languages, version }) => {
  const title = `Open screenshots taken on PS Vita (game version: ${version}, languages: ${languages})`;
  return (
    <a key="vita" href={screenshotsURL} className="px-2 lg:pl-0 lg:pr-2" title={title}>
      <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24" className="w-12 h-12 text-blue-600">
