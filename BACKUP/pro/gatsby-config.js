module.exports = {
    ...
    juin2022) afin d'avoir un sentiment d'utilité envers la population.`,
		...
		projects: [
			{
				...
				description: `Ma galerie de captures d'écran de jeux vidéo. Car le jeu vidéo est aussi un art et la photo aussi. Enfin, quand on a du talent pour la photographie...`,
			...
			},
			{
				...
				description: `Implémentation d'un générateur OpenAPI pour produire un serveur backend basé sur Deno et le middleware oak`,
				link: "https://github.com/Zhykos/deno-server-openapi-generator",
			},
			{
				name: "YMF",
				description: `Framework de gestion de méta-modèle, tout comme EMF, mais pas pareil : générateur de code à partir de méta-modèle déclaré en YAML ou autre (1.0 WIP)`,
		...
		skills: [
			...
			{
				name: "Faibles",
				description: "React, Vue.js, Cobol, Perl, Ansible",
			},
		],
	},
	plugins: [
